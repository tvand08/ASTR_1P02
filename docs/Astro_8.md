...
- Shell of Hydrogen fuses into He releasing energy
- Top layer consists of H(75%) and He(25%) Gas
- The temperature of contracting He-core is very high and the rate of hydrogen fusion in the shell is very high.
- It is higher than the rate of fusion in H-core during the main sequence stage
- The high rate of energy production results in high gas pressure which pushes out the top layers and the star expands.
- As a result, the surface temperature drops because the surface is at a greater distance from the energy producing region.
- Net result:
  - The luminosity increases
  - The surface temperature drops (color changes to orange-red)

### First Red Giant Stage
- The star like our sun is in the first red giant stage (it would expand to the size of the orbit of mercury; this stage would last for 1 billion years)
- When the temperature of a shrinking and heating He-core reaches 100 million K, the <sup>4</sup>He Nuclei will start fusing into <sup>12</sup>C
- H-fusion: a temparutre of 10 million K is needed fo them to get close enough so that they can be fused by the strong, but short ranged, nuclear force.
- He-fusion: The force of electrical repulsion between the nuclei is proportional to the product of their charges. Thus, higher temperatures (min. 100 million K) is needed to fuse <sup>4</sup>He into <sup>12</sup>C.
  - Fusion of <sup>4</sup>He into <sup>12</sup>C is achieved via __Triple-Alpha Process__

### Yellow Giant stage
- __Triple-Alpha Process__
  - <sup>4</sup>He + <sup>4</sup>He ==> <sup>8</sup>Be
  - <sup>8</sup>Be + <sup>4</sup>He ==> <sup>12</sup>C + energy
- The onset of He-fusion into <sup>12</sup>C is called __Helium-Flash__
- The star enters the __Yellow Giant__ stage.
- __Yellow Giant__ stage lasts about 100 million years.
- The energy release per single He-fusion reaction is smaller than the energy released per single H-fusion reaction.
  - Thus the overall fusion rate of He must be higher than the H-fusion during the main sequence and the He is fused much more quickly.
- The amount of energy release after the He-flash is so large that it heats up the core and it expands.
- as a result of the expansion the edge of the core cools down.
- this causes the temperature of the H-fusing shell to drop and the fusion in it stops.
- The removal of this important source of energy causes the pressure to drop. As a result the star starts to shrink.
- The surface gets closer to the energy producing core, changing the color from red to yellow.
- Eventually all of <sup>4</sup>He in the core is fused into <sup>12</sup>C and a star like our sun does not have enough mass to squeeze the carbon core and heat it to the temperatures needed to fuse carbon into heavier nuclei.

### Final Red Giant stage
